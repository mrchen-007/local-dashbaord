...
export default function Sidebar({ currentPage, theme, onNavigate, onToggleTheme }: SidebarProps) {
  return (
    <aside className={`w-64 flex flex-col ${theme === 'dark' ? 'bg-gray-800' : 'bg-white'} border-r`}>
      <div className="p-6">
        <h1 className="text-xl font-bold text-primary">文件去重工具</h1>
        <p className="text-sm text-gray-500 mt-1">V1.1</p>
      </div>
