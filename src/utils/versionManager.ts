...
import { FileInfo, FileVersion, VersionInfo } from '../types';
import { detectVersionTag, extractVersionNumber, isSameFileVersion, calculateNameSimilarity } from './similarity';
